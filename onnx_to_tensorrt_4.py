...
def draw_bboxes(image_raw, bboxes, confidences, categories, all_categories, bbox_color='blue'):
    ...
    for box, score, category in zip(bboxes, confidences, categories):
        ...
        _, _, _, dis3, length = world_info(top, left, bottom, right)
        ...
        image_raw = cv2.putText(image_raw,'{0} {1:.2f} distance: {2:.2f} length: {3:.2f}'.format(all_categories[category], score,dis3,length),(left, top - 12),cv2.FONT_HERSHEY_SIMPLEX,
                        0.5, (0,0,255))
